...
class SummaryTeamNameView extends StatelessWidget {
  const SummaryTeamNameView({Key? key, required this.teamName, required this.textStyle}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      child: Center(child: Text(teamName, style: textStyle)),
    );
  }
}
